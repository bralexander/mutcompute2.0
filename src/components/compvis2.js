...
const Compvis2 = (props) => {
    useEffect (() => {
      // setting up the sources for NGL
    ...
    function loadStructure (proteinFile, csvFile) {
      ...
      return Promise.all([
        ...
        // var firstResNum = parseInt(csv[0][csvResNumCol])
    ...
    return (
        <div id="viewport" style={{height: '100vh', width: '100%'}} >

        </div>
    )
}

export default Compvis2