...
useEffect (() => {
  ...
  //}, []);
    ...
    function addElement (el) {
      ...
      var loadStructureButton = createFileButton('Load Structure', {
        ...
        onchange: function (e) {
          if (e.target.files[0]) {
            ...
            console.log('Struc File uploaded')
          }
          if (loadCsvFile) {
      ...
      // working dynamically with html (embedded.html)
      // var pdbFile = document.getElementById("pdb").getAttribute("data")
      // var csvFile = document.getElementById("csv").getAttribute("data")
      // console.log('p',pdbFile, csvFile)
