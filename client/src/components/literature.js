    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><a href="https://www.biorxiv.org/content/10.1101/2021.08.19.456994v1" >Learning the local landscape of protein structures with convolutional neural networks</a></li>
            </ul>
        </div>
    )
}
